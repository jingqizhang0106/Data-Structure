...
public class ObjectNode
{
   ...
   **/
   // θ(n)
   // pre-conditions: the list should not contain a cycle
    ...
    * Part 1.1
    * @param source
    * @return a recursive version of listCopy()
    */
   // θ(n)
   ...
   **/
    ...
    * Part 1.2
    * @param head
    * @return a recursive version of listLength()
    */
   // θ(n)
    ...
    * Part 1.3
    * @param head
    * @return displays every third node on the list
    */
   // θ(n)
   public static void displayEveryThird(ObjectNode head) {
      ObjectNode dummyhead = new ObjectNode(null, head);
      int listLength = listLength(head);
      int iteration = listLength / 3;
      for (int i = 0; i < iteration; i++) {
         dummyhead = dummyhead.link.link.link;
